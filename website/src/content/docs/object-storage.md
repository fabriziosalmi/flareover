...
|----------|----------|----------|---------|-----|
| `minio` (default) | Self-hosted MinIO | `--minio-endpoint <url>` | n/a | your MinIO creds |
...
| `aruba` | Aruba (EU-owned, IT) | **operator-supplied** via `--minio-endpoint` | n/a | `ARUBA_S3_ACCESS_KEY`, `ARUBA_S3_SECRET_KEY` |
