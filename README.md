...
| Concern | Tool |
|---------|------|
| Authoritative DNS | PowerDNS self-hosted, or managed via `--dns`: EU-owned **bunny.net** · **Scaleway** · **OVHcloud** · **Gandi** · **Leaseweb**, or **Route 53** (AWS — honestly tiered US-operator, *not* sovereign) |
